...
#define HAS_MEDIA 1                    // Added by config.ini
#define INDIVIDUAL_ACIS_HOMING_MENU 1  // Added by config.ini
...
#define STRING_CONFIG_H_AUTHOR "(martin, mpcnc)" // Who made the changes.
...
#define DISABLE_E 0               // Disable the extruder when not stepping
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z 0
 ...
 */
#define EEPROM_SETTINGS 1     // Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT 1  // Init EEPROM automatically on any errors.
