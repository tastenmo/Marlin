 ...
 */
  ...
  #define INVERT_X2_VS_X_DIR 1        // X2 direction signal is the opposite of X
  #define X_DUAL_ENDSTOPS 1           // X2 has its own endstop
...
#if HAS_Y2_STEPPER
  #define INVERT_Y2_VS_Y_DIR 1        // Y2 direction signal is the opposite of Y
  #define Y_DUAL_ENDSTOPS 1           // Y2 has its own endstop
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING 1
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
   ...
   */
  #define SHOW_BOOTSCREEN 1                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 3000       // (ms) Total Duration to display the boot screen(s)
      ...
      #define SHOW_CUSTOM_BOOTSCREEN 1    // Show the bitmap in Marlin/_Bootscreen.h on startup.
    #endif
  #endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define AUTO_REPORT_SD_STATUS 1         // Auto-report media status with 'M27 S<seconds>'
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS 1
 ...
 */
#define CNC_COORDINATE_SYSTEMS 1
...
#define M114_DETAIL 1         // Use 'M114` for details to check planner calculations
...
#define GCODE_MOTION_MODES 1  // Remember the motion mode (G0 G1 G2 G3 G5 G38.X) and apply for X Y Z E F, etc.
...
#define CUSTOM_MENU_MAIN 1
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "mpcnc Custom Menu"
 ...
 */
#define HOST_ACTION_COMMANDS 1
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT 1           // Initiate host prompts to get user feedback
